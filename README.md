...
- Passo 1: Ingestão de Dados e Criação de Memória
Converte o arquivo dados/despesas.csv em "conhecimento vetorial". Rode sempre que atualizar os dados de origem:
   ```bash
...
- Passo 3: Teste sugerido; Peça ao auditor para: "Encontrar os 3 maiores gastos e salvar um relatório detalhado no computador."
...
Solução de Infra: Forçar a instalação da versão CPU do PyTorch: pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cpu
